      ...
      <AnimatePresence>
        {showForgotToast && (
          <motion.div
            ...
            className="fixed top-6 right-4 sm:right-8 z-50 max-w-sm sm:max-w-md p-4 rounded-2xl bg-white/95 backdrop-blur-xl border border-[#fed7d2] shadow-[0_16px_36px_-8px_rgba(234,76,56,0.18)] flex items-start gap-3.5"
            role="alert"
          >
            <div className="w-9 h-9 rounded-xl bg-[#fef2f0] text-[#ea4c38] flex items-center justify-center shrink-0 shadow-xs border border-[#fed7d2]">
            ...
            <div className="flex-1 pr-2">
              <div className="flex items-center gap-1.5 mb-0.5">
                ...
                <span className="text-[9px] font-bold text-[#b45309] bg-[#fefce8] px-1.5 py-0.5 rounded border border-[#fde68a]">
                  Inbox
                </span>
              </div>
              ...
              <div className="mt-1.5 flex items-center gap-1 text-[10px] text-slate-400">
                <Sparkles className="w-3 h-3 text-[#ea4c38]" />
      ...
      <GlassCard className="w-full max-w-sm sm:max-w-md mx-auto shadow-xl p-5 sm:p-7">
        <div className="text-center mb-4">
          <div className="inline-flex p-1 rounded-xl bg-slate-100/90 border border-slate-200/80 mb-3">
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-xs font-semibold transition-all duration-200 cursor-pointer ${
                !isSignUp
                  ? "bg-white text-[#ea4c38] shadow-sm"
          ...
          <h2 className="text-xl sm:text-2xl font-extrabold tracking-tight text-slate-900 mb-1">
            {isSignUp ? (
              <>
                Join <span className="text-[#ea4c38]">Cart</span><span className="text-[#2c3e50]">esian</span>
              </>
            ) : (
              "Welcome Back"
            )}
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 rounded-xl bg-white border border-slate-200 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#ea4c38]/25 focus:border-[#ea4c38] transition-all duration-200"
                  />
                </div>
              </motion.div>
            )}
          ...
          <div>
              ...
              {!isSignUp && (
                <button
                  ...
                  className={`text-xs font-semibold transition-all duration-150 ${
                    isEmailValid
                      ? "text-[#ea4c38] hover:text-[#d93b27] cursor-pointer underline-offset-2 hover:underline"
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-9 py-2 rounded-xl bg-white border border-slate-200 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#ea4c38]/25 focus:border-[#ea4c38] transition-all duration-200 font-mono"
              />
              <button
                type="button"
          ...
          <div className="flex items-center justify-between pt-0.5">
            <label className="flex items-center gap-2 cursor-pointer select-none">
              <input
                ...
                className="w-3.5 h-3.5 rounded text-[#ea4c38] focus:ring-[#ea4c38] border-slate-300 accent-[#ea4c38] cursor-pointer"
              />
          ...
          <motion.button
            ...
            type="submit"
            disabled={isLoading}
            className="w-full py-2.5 px-6 rounded-full text-xs sm:text-sm font-bold text-white btn-primary-orange flex items-center justify-center gap-2.5 transition-all duration-200 cursor-pointer disabled:opacity-75 disabled:cursor-not-allowed mt-1.5"
          >
            {isLoading ? (
              <>
        ...
        <div className="mt-3.5 pt-3 border-t border-slate-100 text-center">
          <p className="text-xs text-slate-500">
            ...
            <button
              ...
              className="font-bold text-[#ea4c38] hover:text-[#d93b27] underline underline-offset-2 transition-colors cursor-pointer"
            >
